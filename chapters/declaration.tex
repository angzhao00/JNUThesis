...
%% 论文题目
\newcommand{\titleCn}{基于分光集成器件的外差式DAS收发一体化光电模组研究}
\newcommand{\titleEn}{Research on an Integrated Transmit--Receive Optoelectronic Module for Heterodyne DAS Based on an Integrated Optical Splitting Device}
%% 导师及其职称

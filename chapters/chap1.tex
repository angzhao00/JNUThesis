...
相干接收和数字解调是在外差φ-OTDR形成之后逐步发展的。2011年，Pan等采用数字相干检测恢复瑞利回波的幅度和相位，为数字下变频和差分相位解调奠定了系统基础\cite{pan2011phase}。随后，研究者围绕I/Q不平衡、检测噪声、频率漂移和偏振衰落分析了相位恢复的误差来源\cite{fu2018iq,lu2021detection,lu2022phaseerror,zhong2021frequency}，并提出偏振分集、相干MIMO、偏振旋转和多频融合等抗衰落路线\cite{dorize2018polarization,mompo2019distributed,guerrier2020mimo,gorajoobi2022polarization,xie2023fading}。数字化相位解调、滑动FFT、空间相移和实时单边带处理等方法则反映了不同系统对计算复杂度、采样方式和实时性的不同取舍\cite{yang2022digitalized,si2023fft_cn,liu2023spatial,liu2025realtime}。

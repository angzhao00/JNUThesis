...
式\eqref{eq:rayleigh_sum}中的多个随机散射相量可能在某些距离位置近似抵消，使合成复包络幅值$A=|S|$接近零。这种由相干瑞利散射随机叠加产生的局部深衰落称为瑞利干涉衰落或相干衰落。它不同于光纤平均损耗：平均损耗随距离缓慢变化，而干涉衰落表现为叠加在平均包络上的随机深谷，且衰落位置会随光频率、温度和应变状态变化\cite{tu2020fading,cheng2023subband,cui2021interference,lei2025fading_cn}。
